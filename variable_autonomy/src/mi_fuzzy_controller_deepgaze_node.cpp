...
void deepgazeCallback(const std_msgs::Int8::ConstPtr& msg);
...
std_msgs::Int8 ai_switch_count_msg_, cognitive_availability_;
...
void MixedInitiativeControllerDeepgaze::deepgazeCallback(const std_msgs::Int8::ConstPtr &msg)
{
